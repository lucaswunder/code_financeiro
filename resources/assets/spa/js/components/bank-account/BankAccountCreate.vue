        ...
        <div class="row">
            ...
            <div class="card-panel z-depth-5">
                <form name="form" method="get" @submit="submit()">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <label class="active">Conta Corrent</label>
                            <input type="text" v-model="bankAccount.account" placeholder="Digite a C/C"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                            <input type="checkbox" v-model="bankAccount.default" class="filled-in"
                                   id="account_default"/>
